...
// Generate unique IP for each request to avoid rate limiting in tests
let ipCounter = 0
...
describe('Auth Routes', () => {
  describe('POST /api/auth/register/options', () => {
    it('returns 400 for missing email', async () => {
      ...
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/register/options', {
          method: 'POST',
  ...
  describe('POST /api/auth/register/verify', () => {
    it('returns 400 for missing email', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/register/verify', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  describe('POST /api/auth/login/options', () => {
    it('returns 400 for missing email', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/login/options', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({}),
        })
  ...
  describe('POST /api/auth/login/verify', () => {
    it('returns 400 for missing email', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/login/verify', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ credential: {} }),
        })
  ...
  describe('POST /api/auth/passkeys/options', () => {
    it('returns 401 without auth token', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/passkeys/options', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        })
      )
  ...
  describe('POST /api/auth/passkeys/verify', () => {
    it('returns 401 without auth token', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/passkeys/verify', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ credential: {} }),
        })
  ...
  describe('GET /api/auth/passkeys', () => {
    it('returns 401 without auth token', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/passkeys', {
          method: 'GET',
        })
      )
      expect(res.status).toBe(401)
  ...
  describe('DELETE /api/auth/passkeys/:id', () => {
    it('returns 401 without auth token', async () => {
      const app = createTestApp()
      const res = await app.fetch(
        createRequest('http://localhost/api/auth/passkeys/some-id', {
          method: 'DELETE',
        })
      )
      expect(res.status).toBe(401)
